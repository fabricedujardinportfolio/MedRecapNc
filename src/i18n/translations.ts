export const translations = {
  fr: {
    ...
    'payment.please_wait': 'Veuillez patienter pendant que nous vérifions votre paiement...',
    'payment.success.title': 'Paiement réussi !',
    'payment.success.description': 'Votre paiement a été traité avec succès.',
    'payment.success.details': 'Détails de la transaction',
    'payment.success.confirmation': 'Une confirmation a été envoyée à votre adresse email.',
    'payment.success.reference': 'Référence de transaction',
    'payment.success.back_to_dashboard': 'Retour au tableau de bord',
    'payment.cancel.title': 'Paiement annulé',
    'payment.cancel.description': 'Votre paiement a été annulé et aucun montant n\'a été débité.',
    'payment.cancel.note': 'Remarque',
    'payment.cancel.message': 'Vous pouvez réessayer le paiement à tout moment depuis votre tableau de bord.',
    'payment.cancel.back_to_dashboard': 'Retour au tableau de bord',
    'payment.cancel.try_again': 'Réessayer le paiement',

    // Subscription
    'subscription.loading': 'Chargement de l\'abonnement...',
    'subscription.error': 'Erreur de chargement',
    'subscription.none': 'Aucun abonnement',
    'subscription.active': 'Abonnement actif',
    'subscription.price': 'Prix',
    'subscription.month': 'mois',
    'subscription.benefit1': 'Accès illimité aux consultations',
    'subscription.benefit2': 'Support prioritaire',
    'subscription.benefit3': 'Mises à jour exclusives',
    'subscription.subscribe': 'S\'abonner maintenant',
    'subscription.processing': 'Traitement...',
    'subscription.current_plan': 'Plan actuel',
    'subscription.status.not_started': 'Non démarré',
    'subscription.status.incomplete': 'Incomplet',
    'subscription.status.incomplete_expired': 'Expiré (incomplet)',
    ...
    'subscription.page.title': 'Gestion des abonnements',
    'subscription.page.heading': 'Abonnements MedRecap+',
    'subscription.page.description': 'Choisissez le plan qui correspond le mieux à vos besoins pour accéder à toutes les fonctionnalités de MedRecap+.',
    'subscription.active.title': 'Abonnement actif',
    'subscription.active.message': 'Vous êtes actuellement abonné au plan {plan}.',
    'subscription.active.renewal': 'Prochain renouvellement le {date}',
    'subscription.active.cancels_at_end': 'Votre abonnement sera annulé à la fin de la période en cours',
    'subscription.error.title': 'Erreur de chargement',
  ...
  en: {
    ...
    'appointment.reminder_description': 'A reminder SMS/email will be sent 24h before the appointment',
    ...
    'payment.success.details': 'Transaction details',
    'payment.success.confirmation': 'A confirmation has been sent to your email address.',
    'payment.success.reference': 'Transaction reference',
    'payment.success.back_to_dashboard': 'Back to dashboard',
    'payment.cancel.title': 'Payment cancelled',
    'payment.cancel.description': 'Your payment has been cancelled and no amount has been charged.',
    'payment.cancel.note': 'Note',
    'payment.cancel.message': 'You can retry the payment at any time from your dashboard.',
    'payment.cancel.back_to_dashboard': 'Back to dashboard',
    'payment.cancel.try_again': 'Try payment again',

    // Subscription
    'subscription.loading': 'Loading subscription...',
    'subscription.error': 'Loading error',
    'subscription.none': 'No subscription',
    'subscription.active': 'Active subscription',
    'subscription.price': 'Price',
    'subscription.month': 'month',
    'subscription.benefit1': 'Unlimited access to consultations',
    'subscription.benefit2': 'Priority support',
    'subscription.benefit3': 'Exclusive updates',
    'subscription.subscribe': 'Subscribe now',
    'subscription.processing': 'Processing...',
    'subscription.current_plan': 'Current plan',
    'subscription.status.not_started': 'Not started',
    'subscription.status.incomplete': 'Incomplete',
    'subscription.status.incomplete_expired': 'Expired (incomplete)',
    ...
    'subscription.page.title': 'Subscription management',
    'subscription.page.heading': 'MedRecap+ Subscriptions',
    'subscription.page.description': 'Choose the plan that best suits your needs to access all MedRecap+ features.',
    'subscription.active.title': 'Active subscription',
    'subscription.active.message': 'You are currently subscribed to the {plan} plan.',
    'subscription.active.renewal': 'Next renewal on {date}',
    'subscription.active.cancels_at_end': 'Your subscription will be canceled at the end of the current period',
