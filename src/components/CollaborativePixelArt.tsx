        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap justify-center sm:justify-between items-center min-h-fit sm:h-16">
            <button
              ...
              className="w-full sm:w-auto mx-auto flex justify-center items-center gap-2 px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-lg transition-colors text-center"
            >
