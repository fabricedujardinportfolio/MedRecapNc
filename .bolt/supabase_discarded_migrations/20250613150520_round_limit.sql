/*
  # Système complet de gestion des patients avec consultations, factures et rendez-vous
  ...
  2. Sécurité
    ...
    - Politiques pour lecture et écriture publique (pour la démo)
...
-- Insérer les patients avec toutes leurs données
INSERT INTO patients (
  id, nom, prenom, sexe, date_naissance, age, lieu_naissance, nationalite, numero_securite_sociale,
...
('PAT-001', 'Dubois', 'Marie', 'F', '1985-03-15', 39, 'Nouméa, New Caledonia', 'French', '2850315123456',
...
('PAT-002', 'Kanak', 'Pierre', 'M', '1992-08-22', 32, 'Lifou, Loyalty Islands', 'French', '1920822234567',
...
('PAT-003', 'Johnson', 'Sarah', 'F', '1988-11-05', 36, 'Sydney, Australia', 'Australian', '2881105345678',
...
('PAT-004', 'Tamate', 'Jean', 'M', '1955-12-10', 69, 'Maré, Loyalty Islands', 'French', '1551210456789',
...
('PAT-005', 'Martin', 'Claire', 'F', '1978-04-18', 46, 'Paris, France', 'French', '2780418567890',
...
('PAT-006', 'Wilson', 'Robert', 'M', '1965-07-30', 59, 'Wellington, New Zealand', 'New Zealand', '1650730678901',
...
('PAT-007', 'Brown', 'Emma', 'F', '2010-02-14', 14, 'Nouméa, New Caledonia', 'French', '3100214789012',
...
('PAT-008', 'Garcia', 'Carlos', 'M', '1970-09-25', 54, 'Madrid, Spain', 'Spanish', '1700925890123',
...
-- Marie Dubois
('PAT-001', 'Amlodipine', '5mg', 'Once daily', '2024-06-01'),
('PAT-001', 'Metformin', '500mg', 'Twice daily', '2024-01-15'),
-- Pierre Kanak
('PAT-002', 'Salbutamol inhaler', '100mcg', 'As needed', '2023-03-10'),
('PAT-002', 'Fluticasone', '50mcg', 'Twice daily', '2023-03-10'),
-- Sarah Johnson
('PAT-003', 'Prenatal vitamins', '1 tablet', 'Once daily', '2024-08-01'),
('PAT-003', 'Iron supplement', '65mg', 'Once daily', '2024-10-15'),
-- Jean Tamate
('PAT-004', 'Lisinopril', '10mg', 'Once daily', '2022-01-01'),
('PAT-004', 'Insulin glargine', '20 units', 'Once daily', '2021-06-15'),
('PAT-004', 'Furosemide', '40mg', 'Twice daily', '2023-03-01'),
-- Claire Martin
('PAT-005', 'Omeprazole', '20mg', 'Once daily', '2023-09-01'),
-- Robert Wilson
('PAT-006', 'Clopidogrel', '75mg', 'Once daily', '2020-08-15'),
('PAT-006', 'Atorvastatin', '40mg', 'Once daily', '2020-08-15'),
('PAT-006', 'Metoprolol', '50mg', 'Twice daily', '2020-08-15'),
-- Emma Brown
('PAT-007', 'Salbutamol inhaler', '100mcg', 'As needed', '2022-05-01'),
('PAT-007', 'Hydrocortisone cream', '1%', 'As needed', '2021-03-15'),
-- Carlos Garcia
('PAT-008', 'Ibuprofen', '400mg', 'Three times daily', '2024-11-01'),
('PAT-008', 'Paracetamol', '500mg', 'As needed', '2024-11-01');

-- Insérer les consultations
INSERT INTO consultations (
  id, patient_id, date, motif, diagnostic, traitement, observations, medecin_nom, duree, type, statut, tarif,
  tension, pouls, temperature, poids, taille
) VALUES
-- Marie Dubois
('CONS-001', 'PAT-001', '2025-01-15 09:30:00', 'Blood pressure check', 'Controlled hypertension', 'Continue antihypertensive treatment', 'Stable blood pressure, good treatment compliance', 'Dr. Martin Dubois', 30, 'suivi', 'terminee', 25,
 '130/80', 72, 36.5, 75, 170),
-- Pierre Kanak
('CONS-002', 'PAT-002', '2025-01-15 14:00:00', 'Persistent cough', 'Acute bronchitis', 'Antibiotic and cough suppressant', 'Productive cough for 5 days, no fever', 'Dr. Martin Dubois', 20, 'consultation', 'terminee', 25,
 '120/75', 68, 36.8, 82, 175),
-- Sarah Johnson
('CONS-003', 'PAT-003', '2025-01-16 10:15:00', 'Pregnancy follow-up', 'Normal pregnancy - 20 weeks gestation', 'Iron supplementation', 'Pregnancy progressing normally, no complications', 'Dr. Martin Dubois', 25, 'suivi', 'terminee', 25,
...
('CONS-001', 'Amlodipine', '5mg', '30 days', '1 tablet in the morning'),
-- Consultation Pierre Kanak
('CONS-002', 'Amoxicillin', '1g', '7 days', '1 tablet morning and evening'),
('CONS-002', 'Cough syrup', '15ml', '5 days', '3 times daily'),
-- Consultation Sarah Johnson
('CONS-003', 'Iron + Folic acid', '1 tablet', '30 days', '1 tablet daily with meals');

-- Insérer les factures
INSERT INTO factures (
  id, patient_id, consultation_id, numero, date, montant_total, montant_paye, montant_restant, statut,
...
('FACT-001', 'PAT-001', 'CONS-001', 'F2025-001', '2025-01-15', 25, 25, 0, 'payee',
 'carte', '2025-01-15', '2025-01-15', 17.50, 7.50, 0),
-- Facture Pierre Kanak
('FACT-002', 'PAT-002', 'CONS-002', 'F2025-002', '2025-01-15', 25, 0, 25, 'en_attente',
 NULL, '2025-02-15', NULL, 17.50, 7.50, 0),
-- Facture Sarah Johnson
('FACT-003', 'PAT-003', 'CONS-003', 'F2025-003', '2025-01-16', 25, 17.50, 7.50, 'partiellement_payee',
...
('FACT-001', 'Follow-up consultation', 1, 25, 25),
-- Détails facture Pierre Kanak
('FACT-002', 'Medical consultation', 1, 25, 25),
-- Détails facture Sarah Johnson
('FACT-003', 'Pregnancy follow-up consultation', 1, 25, 25);

-- Insérer les rendez-vous
INSERT INTO rendez_vous (
  id, patient_id, patient_nom, date, heure_debut, heure_fin, motif, type, statut, medecin_nom, salle, rappel_envoye
) VALUES
-- RDV Marie Dubois
('RDV-001', 'PAT-001', 'Marie Dubois', '2025-01-17', '09:00', '09:30', 'Blood pressure check', 'suivi', 'confirme', 'Dr. Martin Dubois', 'Office 1', true),
-- RDV Jean Tamate
('RDV-002', 'PAT-004', 'Jean Tamate', '2025-01-17', '10:00', '10:30', 'General consultation', 'consultation', 'programme', 'Dr. Martin Dubois', 'Office 1', false),
-- RDV Sarah Johnson
('RDV-003', 'PAT-003', 'Sarah Johnson', '2025-01-17', '14:30', '15:00', 'Pregnancy follow-up', 'suivi', 'confirme', 'Dr. Martin Dubois', 'Office 1', true),
-- RDV Pierre Kanak
('RDV-004', 'PAT-002', 'Pierre Kanak', '2025-01-18', '11:00', '11:30', 'Bronchitis follow-up', 'suivi', 'programme', 'Dr. Martin Dubois', 'Office 1', false);